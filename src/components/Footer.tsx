      ...
      <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16">
        <div className="lg:col-span-2">
          <div className="flex items-baseline gap-3 mb-8">
            <span className="text-3xl font-black tracking-tighter text-primary">INACOM</span>
            <span className="text-[10px] font-bold uppercase tracking-[0.4em] text-white/40">Precisão que se mede</span>
          </div>
          <p className="text-white/40 font-light text-sm max-w-sm leading-relaxed mb-10">
        ...
        <div>
          <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-primary mb-8 text-outline">Contato</h4>
          <address className="not-italic space-y-6" itemScope itemType="https://schema.org/PostalAddress">
            ...
            <div className="flex items-start gap-4">
              ...
              <span className="text-xs font-bold leading-loose text-white/60" itemProp="streetAddress">
